...
const Newsletter = (props: INewsletterProps) => (
  <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
    ...
    <div className="w-full sm:w-5/12">
      <form className="flex rounded-full bg-cod-800 px-4 py-2 focus-within:ring-2 focus-within:ring-cyan-600 hover:ring-2 hover:ring-cyan-600">
        <input className="w-full appearance-none bg-cod-800 focus:outline-none" />
