...
import { formatDate, getNameFromSlug, getReviewTypeFromUrl } from '@/utils/helpers';
...
const ReviewCard = (props: IReviewCardProps) => (
  <div className="flex w-full flex-col overflow-hidden rounded-md bg-cod-900 delay-150 duration-300 md:max-h-[242px] md:flex-row md:gap-1 md:hover:scale-105">
    ...
    <div className="flex flex-col p-3 md:basis-1/4">
      ...
      <div className="mt-1 flex items-center gap-1 text-xs text-gray-400 md:flex-col md:items-start md:gap-0.5">
        <span>
          ...
          {formatDate(props.review.data.reviewDate)}
        </span>
        ...
        <span>
          ...
          {formatDate(props.review.data.releaseDate)}
        </span>
      </div>
    ...
    <div className="flex flex-col gap-2 px-3 pb-3 md:basis-1/2 md:pt-3">
      ...
      {props.review.data.ifYouLiked && (
        <div className="mt-1 flex text-xs text-gray-400">
          <span className="align-middle">
            If you liked this, you might also like{' '}
            <GradientText>{props.review.data.ifYouLiked}</GradientText>
          </span>
        </div>
      )}
    </div>
